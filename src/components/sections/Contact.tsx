      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="rounded-xl border p-5 space-y-3" style={{ background: "#101625", borderColor: "#1a2540" }}>
              {[
                ...
                <div key={row.label} className="flex gap-4 items-baseline text-sm">
                  <span className="font-mono text-xs min-w-[56px]" style={{ color: "#2d3f5a" }}>{row.label}</span>
                  {row.href
                    ? <a href={row.href} style={{ color: "#3b82f6" }}>{row.value}</a>
          ...
          <form onSubmit={handleSubmit} className="lg:col-span-3 rounded-xl border p-8 flex flex-col gap-5"
            ...
            <button type="submit"
              className="w-full py-3.5 rounded-lg text-sm font-bold transition-transform hover:-translate-y-0.5"
